...
$data= mysqli_query($con,"SELECT * FROM tes_tulis LEFT JOIN pelamar ON tes_tulis.id_pelamar = pelamar.nik  WHERE tujuan='Cikarang' AND status='Proses'");
?>
<style>
    li{
        position: relative;
...
<div class="card">
<div class="card-body">
    <h4 class="card-title" style="text-align: center;">Data Pelamar Diproses (Cikarang)</h4>
    <div class="row mb-3">
