...
$data= mysqli_query($con,"SELECT * FROM tes_kesehatan INNER JOIN pelamar ON tes_kesehatan.id_pelamar = pelamar.nik WHERE status='NG MCU' AND tujuan='Cikarang'");
?>
<style>
    li{
        position: relative;
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title" style="text-align: center;">Data Gagal Medical Check's Up (Cikarang)</h4>
            <div class="row mb-3 ">
