...
$data= mysqli_query($con,"SELECT * FROM training INNER JOIN pelamar ON training.id_pelamar = pelamar.nik WHERE status='Training' AND tujuan='Cikarang'");
?>
<style>
    li{
        position: relative;
...
<div class="card">
<div class="card-body">
    <h4 class="card-title" style="text-align: center;">Data Pelamar Sedang Training (Cikarang)</h4>
    <div class="row mb-3">
