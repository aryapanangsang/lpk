...
$data= mysqli_query($con,"SELECT * FROM pelamar WHERE tujuan='Purwakarta' AND status='Mundur' ORDER BY id_pelamar DESC");
...
<div class="card">
<div class="card-body">
    <h4 class="card-title" style="text-align: center;">Data Pelamar Purwakarta</h4>
    <div class="row mb-3">        
