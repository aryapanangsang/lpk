<?php
include('../koneksi.php');
$data= mysqli_query($con,"SELECT * FROM sponsor");
?>
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="tabel-data">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?=$no?></td>                            
                            <td><a href="index.php?halaman=tampilSponsor&id=<?= $tampil['id_sponsor']?>" style="text-decoration: none ; color:black;"><?=$tampil['nama_sponsor']?></a></td>                            
                            <td><?=$tampil['id_sponsor']?></td>
                        </tr>
                        <?php $no++;?>
                        <?php endforeach;?>
                    </tbody>
