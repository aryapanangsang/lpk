...
$data= mysqli_query($con,"SELECT * FROM tes_tulis INNER JOIN pelamar ON tes_tulis.id_pelamar = pelamar.nik WHERE status='OK Test' AND tujuan='Purwakarta'");
?>
<style>
    li{
        position: relative;
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title" style="text-align: center;">Data OK Tes (Purwakarta)</h4>
            <div class="row mb-3">
