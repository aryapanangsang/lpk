...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title" style="text-align: center;">Data OK Medical Check's Up</h4>
            <div class="row">
                <div class="col-sm-3">    
                    <select name="Okmcu" id="Okmcu" class="form-control">
...
<script>
        $(document).ready(function(){   
        $('#live-data').load('p_okMcuGlobal.php');	             
        $('#Okmcu').on('change', function(){        
        const selectedPackage = $('#Okmcu').val();
