													...
													<table class='heading_block block-1' width='100%' border='0' cellpadding='0' cellspacing='0' role='presentation' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt;'>
														<tr>
															<td class='pad' style='padding-bottom:10px;padding-top:10px;text-align:center;width:100%;'>
																<h1 style='margin: 0; color: #4f5aba; direction: ltr; font-family: Noto Serif, Georgia, serif; font-size: 12px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;'><span class='tinyMce-placeholder'>UNDANGAN PELATIHAN (TRAINING)</span></h1>
															</td>
														</tr>
													</table>
													<table class='heading_block block-2' width='100%' border='0' cellpadding='0' cellspacing='0' role='presentation' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt;'>
														<tr>
															<td class='pad' style='padding-bottom:15px;padding-top:10px;text-align:center;width:100%;'>
																<h2 style='margin: 0; color: #201f42; direction: ltr; font-family: Noto Serif, Georgia, serif; font-size: 12px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;'><span class='tinyMce-placeholder'>Selamat <?= $ambil['nama_pelamar']?> Anda Dinyatakan Lulus dan Siap Mengikuti Pelatihan</span></h2>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class='pad' style='padding-left:10px;padding-right:10px;'>
																<div style='color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:10px;font-weight:400;letter-spacing:0px;line-height:180%;text-align:center;mso-line-height-alt:28.8px;'>
																	<p style='margin: 0;'>Cek Disini Untuk Melihat Jadwal Pelaksanaannya</p>
																</div>
															</td>
														</tr>
													</table> 
