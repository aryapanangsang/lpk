...
<div class="container mb-5">    
    ...
    <form class="forms-sample" method="POST" enctype="multipart/form-data">
        <div class="row mt-5">
            ...
            <div class="col-sm-12 mb-4" id="form-reffckr">
            ...
            <div class="col-sm-12 mb-4 " id="form-reff">
                <label for="pilihReferensi">Referensi</label>
                <select name="referensi" id="referensi" class="form-control">
                    <option value="">-Pilih-</option>
                    <option value="Karyawan">Karyawan</option>
                    <option value="tklp">TKLP</option>
                    <option value="Pelamar">Pelamar</option>
                </select>
            </div>     
        </div>    
        ...
        <!-- Referensi Karyawan-->
        <div class="row mt-5" id="form-karyawan">        
            <div class="col-sm-12">
                <h4 class="card-title">Formulir Input Data Karyawan</h4>
                <p class="card-description ">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukan NIP Karyawan" name="nip">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="nama_karyawan">Nama Karyawan</label>      
                    <input type="text" class="form-control" placeholder="Masukan nama karyawan" name="nama_karyawan">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="bagian">Posisi/Bagian</label>
                    <input type="text" class="form-control" placeholder="Masukan Posisi/Bagian Karyawan" name="bagian">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <label for="no_hp">No. Handphone</label>
                    <input type="number" class="form-control" placeholder="Masukan No. Handphone (WA)" name="no_hpKaryawan">
                </div>
            </div>                          
        </div>            
        <!-- Akhir Referensi Karyawan -->

        <!-- Referensi TKLP -->
        <div class="row mt-5" id="form-tklp">        
            <div class="col-sm-12">
                <h4 class="card-title">Formulir Input Data Referensi</h4>                
                <p class="card-description ">
                    Silahkan isi sesuai dengan identitas yang ada!
                </p>  
            </div>           
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="nama_reff">Nama Referensi</label>      
                    <input type="text" class="form-control" placeholder="Masukan nama referensi" name="nama_sponsor">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="no_hp">No. Handphone (62123456789)</label>
                    <input type="number" class="form-control" placeholder="Masukan No. Handphone (WA)" name="id_sponsor">
                </div>
            </div>                                     
        </div>    
        <!-- Akhir Referensi TKLP -->        
        <div class="col-sm-4 tombol">            
...
<script src="vendors/js/vendor.bundle.base.js"></script>
  ...
  <!-- Form Js -->
    ...
    $("#form-karyawan").css("display","none"); //Menghilangkan form-input ketika pertama kali dijalankan
    $("#form-tklp").css("display","none");
    $(".referensi").click(function(){ //Memberikan even ketika class detail di klik (class detail ialah class radio button)
    if ($("input[name='referensi']:checked").val() == "karyawan" ) { //Jika radio button "berbeda" dipilih maka tampilkan form-inputan
    $("#form-karyawan").slideDown("fast"); //Efek Slide Down (Menampilkan Form Input)
    $("#form-tklp").slideUp("fast"); //Efek Slide Down (Menampilkan Form Input)
    } else {
    $("#form-karyawan").slideUp("fast"); //Efek Slide Up (Menghilangkan Form Input)
    
    $("#form-tklp").slideDown("fast"); //Efek Slide Up (Menghilangkan Form Input)
    ...
    <script>
        $(document).ready(function(){
        $("#form-reff").css("display","none");
        $("#form-reffckr").css("display","none");
        $('#tujuan').on('change', function(){        
        const selectedPackage = $('#tujuan').val();
        $('#selected').text(selectedPackage);
            if(selectedPackage == "Cikarang"){
                $("#form-reff").css("display","none");
                $("#form-reffckr").slideDown("slow");                 
            } else {                
                $("#form-reffckr").css("display","none");
                $("#form-reff").slideDown("slow"); 
            }
        });
    });
    ...
    $(document).ready(function(){
        ...
        const selectedPackage = $('#referensi').val();
        $('#selected').text(selectedPackage);
            if(selectedPackage == "Karyawan"){
                $("#form-tklp").css("display","none");
                $("#form-karyawan").slideDown("slow");                 
            } else if(selectedPackage == "tklp") {
                $("#form-karyawan").css("display","none");
                $("#form-tklp").slideDown("slow"); 
            } else{
                $("#form-karyawan").css("display","none");
                $("#form-tklp").css("display","none");
            }
    ...
    $(".referensi").click(function(){ //Memberikan even ketika class detail di klik (class detail ialah class radio button)
    if ($("input[name='referensi']:checked").val() == "karyawan" ) { //Jika radio button "berbeda" dipilih maka tampilkan form-inputan
    $("#form-karyawan").slideDown("slow"); //Efek Slide Down (Menampilkan Form Input)
    $("#form-tklp").css("display","none");
    } else if ($("input[name='referensi']:checked").val() == "tklp" ){
    $("#form-karyawan").css("display","none");
    $("#form-tklp").slideDown("slow"); //Efek Slide Up (Menghilangkan Form Input)    
    }else{
        $("#form-karyawan").slideUp("slow"); //Menghilangkan form-input ketika pertama kali dijalankan
        $("#form-tklp").slideUp("slow");
    }
    });
    });
    </script>
...
if(isset($_POST['tambah'])){   
    ...
    $no_hpKaryawan = htmlspecialchars($_POST['no_hpKaryawan']);    
    ...
    // referensi
    $reffckr = $_POST['referensickr'];
    $reff = $_POST['referensi'];
    ...
    if($jenis_kelamin == 'Laki-laki' && $tb < 166){
        echo"
        <script> Swal.fire({
            icon: 'error',
            title: 'Gagal',
    ...
    if($jenis_kelamin == 'Perempuan' && $tb < 156){
        echo"
        <script> Swal.fire({
            icon: 'error',
            title: 'Gagal',
    ...
    if($tujuan == "Cikarang" && $reffckr == "Oms"){
        if($id_sponsor=='' && $nama_sponsor ==''){
            echo"
            <script> Swal.fire(
                'Gagal',
            ...
            $cekReffckr = mysqli_query($con, "SELECT * FROM sponsor WHERE id_sponsor ='$id_sponsor'");
            if(mysqli_fetch_assoc($cekReffckr)){
                $con->query("INSERT INTO pelamar (nik,email,password,nama_pelamar,jenis_kelamin,tempat_lahir,tgl_lahir,tb,alamat,no_hp,no_hpDarurat,pengalaman,vaksin,tujuan,status,foto,keterangan)
                    VALUES ('$nik','$email','$pw','$nama','$jenis_kelamin','$tempat_lahir','$tgl_lahir','$tb','$alamat','$no_hp','$no_hpDarurat','$pengalaman','$vaksin','$tujuan','$status','$foto','$reffckr')
                ");

                $con->query("INSERT INTO referensi (nip,id_pelamar)
                VALUES('$id_sponsor','$nik')
                ");
            ...
            require 'proses.php'; 
                ...
                $con->query("INSERT INTO sponsor (id_sponsor,nama_sponsor)
                VALUES ('$id_sponsor','$nama_sponsor')
                "); 
    ...
    } elseif ($tujuan == "Cikarang" && $reffckr == "Pelamar"){        
        $con->query("INSERT INTO pelamar (nik,email,password,nama_pelamar,jenis_kelamin,tempat_lahir,tgl_lahir,tb,alamat,no_hp,no_hpDarurat,pengalaman,vaksin,tujuan,status,foto,keterangan)
                 VALUES ('$nik','$email','$pw','$nama','$jenis_kelamin','$tempat_lahir','$tgl_lahir','$tb','$alamat','$no_hp','$no_hpDarurat','$pengalaman','$vaksin','$tujuan','$status','$foto','$reffckr')
            ");
        require 'proses.php'; 

    } elseif ($tujuan == "Purwakarta" && $reff == "Karyawan"){        
        if($nip =='' && $nama_karyawan=='' && $bagian=='' && $no_hpKaryawan==''){
            echo"
            <script> Swal.fire(
                'Gagal',
                'Formulir Belum Lengkap',
            ...
            $cekKaryawan = mysqli_query($con,"SELECT * FROM karyawan WHERE nip='$nip'");
            if (mysqli_fetch_assoc($cekKaryawan)) {
            $con->query("INSERT INTO pelamar (nik,email,password,nama_pelamar,jenis_kelamin,tempat_lahir,tgl_lahir,tb,alamat,no_hp,no_hpDarurat,pengalaman,vaksin,tujuan,status,foto,keterangan)
                VALUES ('$nik','$email','$pw','$nama','$jenis_kelamin','$tempat_lahir','$tgl_lahir','$tb','$alamat','$no_hp','$no_hpDarurat','$pengalaman','$vaksin','$tujuan','$status','$foto','$reff')
                ");
            $con->query("INSERT INTO referensi (nip,id_pelamar)
                VALUES('$nip','$nik')
                ");
            ...
            $con->query("INSERT INTO karyawan (nip,nama_karyawan,bagian,no_hp)
                VALUES ('$nip','$nama_karyawan','$bagian','$no_hpKaryawan')
                ");        
    ...
    } elseif ($tujuan == "Purwakarta" && $reff == "tklp"){
        if($id_sponsor=='' && $nama_sponsor ==''){
            echo"
            <script> Swal.fire(
                'Gagal',
            ...
            $cekReff = mysqli_query($con, "SELECT * FROM sponsor WHERE id_sponsor ='$id_sponsor'");
            if(mysqli_fetch_assoc($cekReff)){
                $con->query("INSERT INTO pelamar (nik,email,password,nama_pelamar,jenis_kelamin,tempat_lahir,tgl_lahir,tb,alamat,no_hp,no_hpDarurat,pengalaman,vaksin,tujuan,status,foto,keterangan)
                    VALUES ('$nik','$email','$pw','$nama','$jenis_kelamin','$tempat_lahir','$tgl_lahir','$tb','$alamat','$no_hp','$no_hpDarurat','$pengalaman','$vaksin','$tujuan','$status','$foto','$reff')
                ");
    ...
    // $cekKaryawan = mysqli_query($con,"SELECT * FROM karyawan WHERE nip='$nip'");
    // if (mysqli_fetch_assoc($cekKaryawan)) {
    //     $con->query("INSERT INTO pelamar (nik,email,password,nama_pelamar,jenis_kelamin,tempat_lahir,tgl_lahir,tb,alamat,no_hp,pengalaman,vaksin)
    //     VALUES ('$nik','$email','$pw','$nama','$jenis_kelamin','$tempat_lahir','$tgl_lahir','$tb','$alamat','$no_hp','$pengalaman',$vaksin)
    // ");
    //     $con->query("INSERT INTO referensi (nip,id_pelamar)
    //     VALUES('$nip','$nik')
    //     ");
